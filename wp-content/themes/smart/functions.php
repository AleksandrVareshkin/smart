...
function smart_setup()
{
	...
	register_nav_menu('Property', 'Property menu');
...
{
	wp_enqueue_style('smart-style', get_stylesheet_uri(), array(), _S_VERSION);
	wp_style_add_data('smart-style', 'rtl', 'replace');

	wp_enqueue_script('smart-navigation', get_template_directory_uri() . '/js/navigation.js', array(), _S_VERSION, true);
